...
public class insea extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button si1Btn = view.findViewById(R.id.si1btn);
        si1Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-1");
            }
        });

        Button si2Btn = view.findViewById(R.id.si2btn);
        si2Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-2");
            }
        });

        Button si3Btn = view.findViewById(R.id.si3btn);
        si3Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-3");
            }
        });

        Button si4Btn = view.findViewById(R.id.si4btn);
        si4Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-4");
            }
        });

        Button si5Btn = view.findViewById(R.id.si5btn);
        si5Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-5");
            }
        });

        Button si6Btn = view.findViewById(R.id.si6btn);
        si6Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showBottomSlider("SI-6");
            }
        });
    ...
    private void showBottomSlider(String Button) {
        ...
        if (userDetails != null) {
            ...
            location.setText("Sea: Inside("+ Button +")");
        ...
        if (confirmBtn != null) {
            confirmBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    reservation.setSeatingArea("Sea: Inside("+ Button +")");
